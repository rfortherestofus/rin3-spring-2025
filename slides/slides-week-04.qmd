...
1. Copy the code from [this Quarto document](https://raw.githubusercontent.com/rfortherestofus/rin3-spring-2025/refs/heads/main/misc/no-render.qmd). Figure out why it won't render and change it so that it will!

1. Copy the code from [this second Quarto document](https://raw.githubusercontent.com/rfortherestofus/rin3-spring-2025/refs/heads/main/misc/guess-what.qmd). There are a series of questions in it. Tackle them one by one, making changes to the document as you do so.
...
- [We've added a lesson from previous coach Charlie on reading documentation pages](https://rfortherestofus.com/courses/r-in-3-months-spring-2025/lessons/understanding-documentation-pages)

- Also [check out the appendix in Kieran Healy's book](https://socviz.co/appendix.html#a-little-more-about-r)

::: {.notes}
https://rfortherestofus.com/courses/r-in-3-months-spring-20des25/lessons/understanding-documentation-pages
:::
