...
# Misc Questions {.inverse}

1. Functions that take variables as arguments

1. Dealing with fonts in various places

1. Setting default color/fill palettes
...
1. Surveys on your [progress](https://rfortherestofus.com/courses/r-in-3-months-spring-2025/lessons/r-in-3-months-progress-survey) and on [feedback](https://rfortherestofus.com/courses/r-in-3-months-spring-2025/lessons/r-in-3-months-feedback-survey) for R in 3 Months
  
1. Please complete final projects **even if you haven't completed every single lesson**

1. Add info about your final project on [this Google Slides presentation](https://docs.google.com/presentation/d/1crH3G9yiksU_INYET-UGhIofWMwQQtkJJAjvEwLzyxE/edit?usp=sharing)
